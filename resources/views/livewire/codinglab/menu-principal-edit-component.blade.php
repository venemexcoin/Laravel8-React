...
<div>
    ...
    <div class="form">
        ...
        @endif
      <form wire:submit.prevent="vistaUpdate">

        <input type="text" value="Title"  wire:model="title" />
        @error('title') <p class="text-danger">{{$message}}</p> @enderror
        <input type="text" value="Fuente" wire:model="widget1" />
        @error('title') <p class="text-danger">{{$message}}</p> @enderror
        <input type="text" value="Tipo"   wire:model="widget2" />
        @error('title') <p class="text-danger">{{$message}}</p> @enderror
        <input type="text" value="Fecha"  wire:model="widget3" />
        @error('title') <p class="text-danger">{{$message}}</p> @enderror
        <input type="text" value="Ruta"   wire:model="ruta"/>
        @error('title') <p class="text-danger">{{$message}}</p> @enderror
        <input type="file" value="Imagen" wire:model="newimage" />
        @if($newimage)
        <img src="{{$newimage->temporaryUrl()}}" width="120">
        @else 
           <img src="{{asset('assets/img/Menu')}}/{{$image}}" width="70">
        @endif
