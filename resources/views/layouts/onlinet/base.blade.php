...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/onlinetutorial/base.css')}}">
...
<body>
    ...
    <label class="button bars" for="check"><i class="fas fa-bars"></i></label>
     <div class="side-bar">
         ...
         <ul>
             ...
             <li><a href="{{route('online.index')}}"><i class="fas fa-link"></i>OnlineTutorial</a></li>
    ...
    <script src="{{asset('assets/js/onlinetutorial/base.js')}}"></script>
    @livewireScripts
    @stack('scripts')
</body>
</html>